function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}const size = 512;
...
class Mandelbrot {
  constructor() {_defineProperty(this, "setup",
    ...
    });this.left = -2;this.top = -2;this.viewSize = 4;this.colorScheme = 'deep ocean';this.setup();this.draw();}reset() {this.left = -2;this.top = -2;this.viewSize = 4;this.setup();}}
...
gui.add(_, 'colorScheme', Object.keys(colorConfigs)).onFinishChange(_.setup);
gui.add(_, 'reset');
